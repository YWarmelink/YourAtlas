...
- **Route-line map view**: a second map mode ("📍 Routelijn" next to "🌍 Landen")
  ...
  once its destinations carry `lat`/`lng` (eight expeditions have this so far: Eurasia
  ...
  Grand Roadtrip 🚗, British Isles & Celtic Coast Expedition 🍀 and North America
  Grand Traverse 🌎 — see `ROUTE_LOGIC_REVIEW.md` for the rollout plan to the rest).
