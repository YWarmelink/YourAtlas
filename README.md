...
- **Route-line map view**: a second map mode ("📍 Routelijn" next to "🌍 Landen")
  ...
  once its destinations carry `lat`/`lng` (ten expeditions have this so far: Eurasia
  ...
  Grand Traverse 🌎, West & Central Africa Expedition 🌍 and Oceania Grand
  Expedition 🌊 — see `ROUTE_LOGIC_REVIEW.md` for the rollout plan to the rest).
