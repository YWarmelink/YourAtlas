...
- **Route-line map view**: a second map mode ("📍 Routelijn" next to "🌍 Landen")
  ...
  once its destinations carry `lat`/`lng` (twelve expeditions have this so far: Eurasia
  ...
  Expedition 🌊, Pan-American Grand Tour 🌎 and Mediterranean Civilizations
  Expedition 🏛️ — see `ROUTE_LOGIC_REVIEW.md` for the rollout plan to the rest).
