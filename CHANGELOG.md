...
- **Per-destination notes, batch 30 — France + Switzerland + Italy (10-14 days) (2026-09-17)** —
  ...
  confirmed touched in the live simulation. App-wide total: 2583 destination-slots filled across
  319 routes. 292/741 signatures done.
...
- **Per-destination notes, batch 20 — Czechia + Austria + Hungary (10-14 days) (2026-09-17)** —
  ...
  batch: overlaps Czechia + Austria (9 days) and Budapest + Eger (5 days). Same generic
  name-matching migration (`rbMigrateCzechiaAustriaHungaryDestinationNotes()`) — 10 routes
  confirmed touched in the live simulation. App-wide total: 2417 destination-slots filled across
  298 routes. 239/741 signatures done.
...
- **Per-destination notes, batch 13 — Croatia + Montenegro + Bosnia (12 days) (2026-09-17)** — a
  ...
  name-matching migration (`rbMigrateCroatiaMontenegroBosniaDestinationNotes()`) — 26 routes
  confirmed touched in the live simulation. App-wide total: 2083 destination-slots filled across
  226 routes. 173/741 signatures done.
