...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  rbMigrateRomeTuscanyDestinationNotes();
  rbMigrateSicilySouthernItalyDestinationNotes();
  rbMigratePortugalAndalusiaDestinationNotes();
  rbMigrateSwitzerlandAlpineDestinationNotes();
  rbMigrateFranceSwitzerlandItalyDestinationNotes();
  rbMigrateSerbiaMontenegroBosniaDestinationNotes();
  rbMigrateFaroeIcelandDestinationNotes();
  rbMigrateMadeiraPortoSantoDestinationNotes();
  rbMigrateCanaryIslandsDestinationNotes();
  rbMigrateDelhiDestinationNote();
  rbMigrateBavariaBerlinDresdenDestinationNotes();
  rbMigrateKosovoAlbaniaDestinationNotes();
  rbMigrateItalySloveniaCroatiaDestinationNotes();
  rbMigrateLuxembourgBeneluxDestinationNotes();
  rbMigrateSanMarinoEmiliaRomagnaDestinationNotes();
  rbMigrateAlbaniaClusterDestinationNotes();
  rbMigrateNorthMacedoniaKosovoGreeceDestinationNotes();
  rbMigratePeruBoliviaAndesDestinationNotes();
  rbMigrateMalaysiaBorneoBruneiDestinationNotes();
  rbMigrateDolomitesDestinationNotes();
  rbMigratePortoNorthernSpainDestinationNotes();
  rbMigrateNorthernSpainRoadtripExtrasDestinationNotes();
  rbMigrateLisbonSintraExtrasDestinationNotes();
  rbMigrateMinhoExtrasDestinationNotes();
  rbMigrateRomeExtrasDestinationNotes();
  rbMigratePortoCityExtrasDestinationNotes();
  rbMigrateAlgarveExtrasDestinationNotes();
  rbMigrateCentralPortugalDouroAlentejoDestinationNotes();
  rbMigrateIcelandClusterDestinationNotes();
  rbMigrateUSNortheastDestinationNotes();
  rbMigrateUSSouthwestDestinationNotes();
  rbMigrateHawaiiDestinationNotes();
  rbMigrateFloridaDestinationNotes();
  rbMigrateSicilyMaltaClusterDestinationNotes();
  rbMigrateCorsicaClusterDestinationNotes();
  rbMigrateCoteDazurClusterDestinationNotes();
  rbMigrateAndorraPyreneesClusterDestinationNotes();
  rbMigrateMonacoCoteDazurExtrasDestinationNotes();
  rbMigrateMonacoProvenceExtrasDestinationNotes();
  rbMigrateProvenceExtrasDestinationNotes();
  rbMigrateCorsicaSardiniaDestinationNotes();
  rbMigrateSardiniaExtrasDestinationNotes();
  rbMigrateRomeVaticanExtrasDestinationNotes();
  rbMigrateMaltaGozoExtrasDestinationNotes();
  rbMigrateCentralPortugalSerraExtrasDestinationNotes();
  rbMigrateAthensPeloponneseClusterDestinationNotes();
  rbMigrateNorthernGreeceClusterDestinationNotes();
  rbMigrateRomaniaClusterDestinationNotes();
  rbMigrateBulgariaClusterDestinationNotes();
  rbMigrateMoldovaClusterDestinationNotes();
  rbMigrateScotlandClusterDestinationNotes();
  rbMigrateIcelandLeftoversDestinationNotes();
  rbMigrateIrelandClusterDestinationNotes();
  rbMigrateIrelandCombosDestinationNotes();
  ...
  rbMigrateEnglandWalesNIExtrasDestinationNotes();
  rbMigrateGaliciaExtrasDestinationNotes();
  rbMigrateGibraltarAndalusiaExtrasDestinationNotes();
  rbMigrateAlsaceExtrasDestinationNotes();
  rbMigratePugliaExtrasDestinationNotes();
  rbMigrateSpainNorthCentralExtrasDestinationNotes();
  rbMigrateSpainEastSouthExtrasDestinationNotes();
  rbMigrateMontenegroRoadtripExtrasDestinationNotes();
  rbMigrateCyprusRoadtripExtrasDestinationNotes();
  rbMigrateNorwayClusterDestinationNotes();
  rbMigrateAndorraAriegeExtrasDestinationNotes();
  rbMigrateDenmarkSwedenExtrasDestinationNotes();
  rbMigrateTenerifeGomeraExtrasDestinationNotes();
  rbMigrateIsleOfManExtrasDestinationNotes();
  rbMigrateNorwayLeftoversDestinationNotes();
  rbMigrateAsturiasCantabriaLeftoverDestinationNotes();
  rbMigrateFrenchSpanishPyreneesDestinationNotes();
  rbMigrateSriLankaDestinationNotes();
  rbMigratePapuaNewGuineaDestinationNotes();
  rbMigrateLoireValleyDestinationNotes();
  rbMigrateCampaniaAmalfiDestinationNotes();
  rbMigrateProvenceCoteDazurLeftoverDestinationNotes();
  rbMigratePortugalSpainLeftoverDestinationNotes();
  ...
  rbMigrateParisDestinationNotes();
  rbMigrateFrenchAlpsProvenceDestinationNotes();
  rbMigrateWesternCanadaAlaskaLeftoverDestinationNotes();
  ...
  rbMigrateSpainAndorraClusterDestinationNotes();
  ...
  rbMigrateAlpineAdriaticCluster4DestinationNotes();
  rbMigrateEuropeMixedCluster5DestinationNotes();
  rbMigrateSoloNationsCluster1DestinationNotes();
  rbMigrateEuropeTailCluster6DestinationNotes();
